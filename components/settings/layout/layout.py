...
class Layout:
    def __init__(self, name, layout_type: LayoutType):
        self.name = name
        self.layout_type = layout_type
        self.sub_layouts = {}

    def add_sub_layout(self, name, layout_type: LayoutType):
        sub_layout = Layout(name, layout_type)
...
class LayoutManager:
    ...
    def move_to_parent_layout(self, parent_layout: Layout):
        self.current_layout = parent_layout
...
display_settings.add_sub_layout('BRIGHTNESS', LayoutType.LayoutText)
display_settings.add_sub_layout('RESOLUTION', LayoutType.LayoutText)
display_settings.add_sub_layout('ORIENTATION', LayoutType.LayoutText)
