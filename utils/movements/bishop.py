def bishop_moves(board, color, x, y):
    """
    Lists all possible moves for a bishop piece.
    
    Args:
        board (list): The current state of the chess board.
        color (str): The color of the bishop ('white' or 'black').
        x (int): The x-coordinate of the bishop (1-8).
        y (int): The y-coordinate of the bishop (1-8).
    ...
    for dx, dy in directions:
        ...
        # Move in each direction until the bishop is blocked or goes off the board
        while True:
            new_x += dx
            new_y += dy
